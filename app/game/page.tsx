...
export default function GamePage() {
  ...
  function handleCashierKey(key: string) {
    ...
    if (key !== expectedKey) {
      ...
      setMessage(`실수! ${cashierSequence[cashierIndex]} 키를 눌러야 했습니다.`);
  ...
  function handleSecurityAction() {
    ...
    setCash((money) => Math.max(0, money - 100));
    setSecuritySignal("normal");
    setMessage("🛡️ 평범한 손님을 막았습니다. 벌금 100원");
  }
...
const lobbyLayoutStyle: CSSProperties = { width: "100%", height: "100%", padding: "18px", display: "grid", gridTemplateRows: "auto 1fr auto", gap: "18px" };
const lobbyHeaderStyle: CSSProperties = { display: "grid", gridTemplateColumns: "1fr auto", alignItems: "start", gap: "24px" };
const smallLabelStyle: CSSProperties = { color: "#7dd3fc", fontSize: "13px", fontWeight: 900, letterSpacing: "0.12em" };
const mainTitleStyle: CSSProperties = { margin: "2px 0", fontSize: "42px", lineHeight: 1 };
const subtitleStyle: CSSProperties = { margin: 0, color: "#dbeafe", fontSize: "16px" };
const moneyPanelStyle: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(6, 112px)", gap: "8px" };
const statusPillStyle: CSSProperties = { background: "rgba(15,23,42,0.78)", border: "1px solid rgba(255,255,255,0.18)", borderRadius: "12px", padding: "8px 10px", minWidth: "88px", display: "grid", gap: "2px", fontSize: "13px" };
const statusLabelStyle: CSSProperties = { color: "#94a3b8", fontSize: "10px" };
const jobGridStyle: CSSProperties = { minHeight: 0, display: "grid", gridTemplateColumns: "repeat(5, minmax(0, 1fr))", gap: "16px", alignItems: "stretch" };
const jobCardStyle: CSSProperties = { height: "100%", minHeight: "220px", borderRadius: "20px", padding: "22px", background: "rgba(255,255,255,0.10)", color: "white", textAlign: "left", cursor: "pointer", boxShadow: "0 16px 40px rgba(0,0,0,0.25)" };
const jobIconStyle: CSSProperties = { fontSize: "48px", marginBottom: "18px" };
const jobCardTitleStyle: CSSProperties = { margin: "0 0 10px", fontSize: "22px" };
const jobCardTextStyle: CSSProperties = { margin: 0, color: "#dbeafe", lineHeight: 1.45, fontSize: "15px" };
const rewardTextStyle: CSSProperties = { marginTop: "18px", color: "#86efac", fontWeight: 900, fontSize: "15px" };
const lobbyFooterStyle: CSSProperties = { display: "grid", gridTemplateColumns: "1fr auto", alignItems: "center", gap: "12px" };
const messageBoxStyle: CSSProperties = { minHeight: "44px", display: "flex", alignItems: "center", background: "rgba(34,197,94,0.12)", border: "1px solid rgba(34,197,94,0.28)", borderRadius: "14px", padding: "10px 14px", color: "#dcfce7", lineHeight: 1.3, fontSize: "14px" };
const bigStartButtonStyle: CSSProperties = { border: "none", borderRadius: "14px", background: "#38bdf8", color: "#020617", padding: "14px 20px", fontWeight: 900, fontSize: "15px", cursor: "pointer" };
const jobOnlyLayoutStyle: CSSProperties = { width: "100%", height: "100%", padding: "12px", display: "grid", gridTemplateRows: "auto auto 1fr auto", gap: "8px" };
const compactHeaderStyle: CSSProperties = { display: "grid", gridTemplateColumns: "1fr auto", alignItems: "center", gap: "10px" };
const jobTitleStyle: CSSProperties = { margin: "1px 0 0", fontSize: "28px" };
...
const difficultyBannerStyle: CSSProperties = { background: "rgba(250,204,21,0.16)", border: "1px solid rgba(250,204,21,0.5)", color: "#fef3c7", borderRadius: "12px", padding: "8px 12px", textAlign: "center", fontWeight: 900 };
const jobStageStyle: CSSProperties = { minHeight: 0, display: "flex", alignItems: "center", justifyContent: "center" };
const jobFooterStyle: CSSProperties = { display: "grid", gridTemplateColumns: "1fr auto", gap: "8px", alignItems: "center" };
const controlHintStyle: CSSProperties = { background: "rgba(15,23,42,0.75)", border: "1px solid rgba(255,255,255,0.14)", borderRadius: "12px", padding: "10px 12px", color: "#cbd5e1", fontWeight: 900, fontSize: "13px" };
...
const sortingStageStyle: CSSProperties = { width: "min(880px, 94vw)", height: "min(460px, 62svh)", display: "grid", gridTemplateRows: "auto 1fr auto", gap: "12px" };
...
const runnerStageStyle: CSSProperties = { width: "min(700px, 92vw)", height: "min(560px, 70svh)", display: "grid", gridTemplateRows: "1fr auto", gap: "8px" };
...
const cafeStageStyle: CSSProperties = { width: "min(620px, 90vw)", height: "min(500px, 65svh)", display: "grid", gridTemplateRows: "auto 1fr", gap: "10px" };
...
const cupStyle: CSSProperties = { position: "relative", width: "190px", height: "285px", border: "6px solid rgba(255,255,255,0.85)", borderTop: "none", overflow: "hidden", background: "rgba(255,255,255,0.08)" };
...
const securityStageStyle: CSSProperties = { width: "min(620px, 90vw)", height: "min(430px, 58svh)", display: "grid", gridTemplateRows: "auto 1fr", gap: "8px" };
