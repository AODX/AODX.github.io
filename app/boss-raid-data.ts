...
export const BOSS_RAIDS: BossRaidDefinition[] = [
  ...
  // Apex Time bosses: these five alone occupy THREAT 5.
  {
    ...
    description: '여명의 지배자를 핵심으로 여명 시간 카드를 연쇄해 초반부터 턴의 흐름 자체를 장악합니다.',
    phase: 'dawn',
  ...
  },
  {
    ...
    description: '정점의 왕을 중심으로 정점 고정과 폭발적인 전투 교환을 반복하는 최상위 시간 보스입니다.',
    phase: 'zenith',
  ...
  },
  {
    ...
    description: '황혼의 기사를 중심으로 수호·돌진·시간 고정을 겹쳐 중반 이후 전투 교환을 압도합니다.',
    phase: 'dusk',
  ...
  },
  {
    ...
    description: '심야의 침묵을 중심으로 ENERGY·손패·함정 타이밍을 통제해 플레이 선택지를 계속 줄입니다.',
    phase: 'midnight',
  ...
  },
  {
    ...
    description: '개기일식의 조율자를 중심으로 최고급 시간 조작과 시간대 전환을 연계하는 최종 보스입니다.',
    phase: 'eclipse',
