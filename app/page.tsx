    ...
    <div className="view-stack v6-shop-view v17-shop-view">
      ...
      {shopTab === 'packs' ? (
        ...
        <div className="v34-emote-store">
          <header className="v34-emote-store-head"><span>CHAT + DUEL EMOTE MARKET</span><h3>감정표현</h3><p>도로롱 · NIKKE · 트릭컬 · 가디언테일즈 · 망그러진 곰 · 이렘티콘 · 동방티콘은 각각 6종입니다. 동방티콘은 제공받은 원본 이미지를 기반으로 선명화해 적용했습니다. 모든 개별 이모티콘은 1,000코인, 6종 세트는 5,000코인이며 보유한 이모티콘 중 최대 6개만 장착해 채팅과 대전에서 공통으로 사용합니다.</p></header>
